...
SEED: dict = {
    ...
    "description": ("Wie souverän ist Ihre Organisation im Umgang mit Künstlicher Intelligenz? Dieser Check bewertet Ihren KI-Reifegrad in 4 Dimensionen."),
    ...
    "maturity_levels": [
        ...
        },
        {
            ...
            "label": "KI-Lernender",
            "description": (
                "Erste KI-Initiativen sind gestartet, aber noch nicht systematisch verankert. Daten-Infrastruktur und Governance-Strukturen sind im Aufbau."
            ),
            "color": "#EA580C",
            "icon": "book-open",
            "pct_min": 25,
        ...
        },
        {
            ...
            "description": (
                "KI ist in wesentlichen Bereichen operativ im Einsatz. Governance und Kompetenzen sind entwickelt, aber noch nicht vollständig integriert."
            ),
            "color": "#CA8A04",
            "icon": "trending-up",
            "pct_min": 50,
        ...
        },
        {
            ...
            "label": "KI-Souverän",
            "description": (
                "Ihre Organisation gestaltet KI-Transformation aktiv und souverän. Strategie, Daten, Kompetenz und Compliance sind systematisch verankert."
            ),
            "color": "#16A34A",
            "icon": "shield-check",
            "pct_min": 75,
